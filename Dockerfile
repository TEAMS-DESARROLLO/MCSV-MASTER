...
EXPOSE $PORT
# COPY *.jar /app/mcsv-master-1.0.1.jar 
COPY *.jar /app/master.jar 
...
ENTRYPOINT exec java $JAVA_OPTS -jar /app/masterjar --eureka.client.serviceUrl.defaultZone=${EUREKA_SERVER}