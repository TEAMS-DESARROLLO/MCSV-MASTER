...
public class StatusCollaboratorController {
	...
	private final IPaginationCommons<StatusCollaboratorResponseDTO> paginationCommons; 
	...
	public ResponseEntity<List<StatusCollaboratorResponseDTO>> findAll(){
		List<StatusCollaboratorEntity> unitsMeasureEntities = this.service.getAll();
		List<StatusCollaboratorResponseDTO> unitsMeasureDTO = this.mapper.listEntityToDTO(unitsMeasureEntities);
