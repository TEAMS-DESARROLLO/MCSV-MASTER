    ...
    public StringBuilder getFilters(List<Filter> filters) {
        ...
        for(Filter filtro:filters){
            ...
            if(filtro.getField().equals("lastName")){
                sql.append(" AND a.lastName LIKE :lastName ");
            }
            ...
            if(filtro.getField().equals("leaderNames")){
                sql.append(" AND l.names LIKE :leaderNames ");
            }
            ...
            if(filtro.getField().equals("rolDescription")){
                sql.append(" AND r.description LIKE :rolDescription ");
            }
            ...
            if(filtro.getField().equals("regionDescription")){
                sql.append(" AND rg.description LIKE :regionDescription ");
            }
