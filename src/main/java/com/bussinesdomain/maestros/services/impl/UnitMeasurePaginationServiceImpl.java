...
public class UnitMeasurePaginationServiceImpl implements IPaginationCommons<UnitMeasureResponseDTO> {
		
	private final EntityManager entityManager;
	
	@Override
	public Page<UnitMeasureResponseDTO> pagination(PaginationModel pagination) {
		try {
			...
			List<UnitMeasureResponseDTO> lista = querySelect.getResultList();

			PageRequest pageable = PageRequest.of(pagination.getPageNumber(), pagination.getRowsPerPage());

			Page<UnitMeasureResponseDTO> page = new PageImpl<UnitMeasureResponseDTO>(lista, pageable, total);
	...
	public StringBuilder getSelect() {
		StringBuilder sql = new StringBuilder("SELECT new com.bussinesdomain.maestros.dto.UnitMeasureResponseDTO(u.idUnitMeasure,u.name) ");
        return sql;
	}

	@Override
	public StringBuilder getFrom() {
		StringBuilder sql = new StringBuilder(" FROM UnitMeasureEntity u  ");
        return sql;
	}
